<template>
  <div class="md:pt-40 pt-28 md:pb-32 pb-24">
    ...
    <div class="md:pl-8 mt-10">
      <CommonContact />
      <p class="mt-8 dark:text-neutral-400 text-neutral-600">
        Or contact me with...
      </p>
      <div class="mt-4 flex gap-4 items-center flex-wrap">
        ...
        >
          <svg
            ...
            class="dark:fill-neutral-400 fill-neutral-500 md:w-6 w-5 md:h-6 h-5"
            viewBox="0 0 640 640"
          >
            <path
          ...
          <p
            class="dark:text-neutral-400 text-neutral-600 md:text-base text-sm"
          >
            LinkedIn
          </p>
        </a>
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="dark:fill-neutral-400 fill-neutral-500 md:w-7 w-6 md:h-7 h-6"
            viewBox="0 0 640 640"
          >
            <path
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="dark:fill-neutral-400 fill-neutral-500 md:w-6 w-5 h-5 md:h-6"
            viewBox="0 0 640 640"
          >
            <path
