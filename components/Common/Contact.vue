  ...
  <div>
    ...
    <div class="md:pl-8 mt-8">
      <form @submit="onSubmit">
        <div class="md:p-6 p-4 border border-neutral-200 dark:border-neutral-800 rounded-sm md:shadow-md shadow bg-neutral-100 dark:bg-[#191919]">
          <div class="grid md:grid-cols-2 md:gap-6 gap-4">
            <div class="flex flex-col gap-2">
              <label for="name" class="md:text-lg text-base font-normal text-neutral-500 dark:text-neutral-400">
            ...
            <div class="flex flex-col gap-2">
              <label for="email" class="md:text-lg text-base font-normal text-neutral-500 dark:text-neutral-400">
          ...
          <div class="flex flex-col gap-2 mt-4">
            <label for="message" class="md:text-lg text-base font-normal text-neutral-500 dark:text-neutral-400">
          ...
          <div class="flex lg:flex-row flex-col lg:items-center gap-6 mt-6">
            ...
            <transition name="fade">
                <p class="md:text-base dark:text-neutral-200 text-neutral-800 text-sm tracking-tight flex items-center gap-3 " v-show="responseBadge.show">
                    <CircleX v-if="responseBadge.type == 'error'" class="sm:w-5 w-10 text-red-500" />
...
const onSubmit = handleSubmit(async (values) => {
  try {
    const url = `https://formsubmit.co/${useRuntimeConfig().public.formSubmitKey}`
    await $fetch(url, {
      method: 'POST',
      body: values,
    })

    handleResponseBadge("Got it! I’ll reach out to you as soon as possible.", "success");
    resetForm()
  } catch (error) {
