  ...
  <div class="flex gap-2.5 items-center mt-4">
    ...
    >
      <svg
        ...
        class="dark:fill-neutral-400 fill-neutral-500 w-5 h-5"
        viewBox="0 0 640 640"
      >
        <path
    ...
    <a
      class="p-1.5 border dark:border-neutral-700 border-neutral-200 aspect-square rounded-full dark:bg-neutral-800 bg-neutral-200"
    ...
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="dark:fill-neutral-400 fill-neutral-500 w-6 h-6"
        viewBox="0 0 640 640"
      >
        <path
